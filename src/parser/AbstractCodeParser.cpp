...
std::vector<std::string> AbstractCodeParser::GetFilePaths() const noexcept {
  return file_paths_;
}

std::unordered_map<std::string, std::string> AbstractCodeParser::GetSettings() const noexcept {
  return settings_;
}
